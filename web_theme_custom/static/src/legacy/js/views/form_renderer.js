    ...
    FormRenderer.include({
        ...
        _updateAllModifiers: function () {
            return this._super.apply(this, arguments).then(() => {
                ...
                const $statusbarButtons = $statusbarButtonsContainer
                    .find("button.btn")
                    .toArray();
                $statusbarButtonsContainer.replaceWith(
                    this._renderStatusbarButtons($statusbarButtons)
                );
            });
        },
    });
