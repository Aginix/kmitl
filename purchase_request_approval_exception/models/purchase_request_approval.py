...
class PurchaseRequestApproval(models.Model):
    _inherit = ["purchase.request.approval", "base.exception"]
    ...
    def _get_popup_action(self):
        action = self.env.ref(
            "purchase_request_approval_exception.action_purchase_request_approval_exception_confirm"
        )
        return action
