...
class ResUsers(models.Model):
    ...
    def get_my_oversight_todo_count(self):
        """Simple counter used by clients (e.g. custom systray) that want a
        boolean-ish signal for whether the user has anything sitting in
        oversight. Kept separate from ``get_my_todo_count`` because the
        oversight view is silent by design (does not push a badge)."""
