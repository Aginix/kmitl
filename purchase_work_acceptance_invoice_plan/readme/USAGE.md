...
- To create Work Acceptance, click button "Create WA by Installment"
  ...
  - For better control of product line to be on WA, select **Based On** 1) All product
    lines 2) Product line with matched amount

- Accept the Work Acceptance.

**Note:** the **Based On** option is create by server action, it is possible to create
more option.
