...
export class BudgetAppropriationRevenueF4 extends Component {
    setup() {
...
BudgetAppropriationRevenueF4.template = "budget.BudgetAppropriationRevenueF4";
BudgetAppropriationRevenueF4.components = { 
    ControlPanel
};

registry.category("actions").add("budget_appropriation_revenue_f4", BudgetAppropriationRevenueF4);