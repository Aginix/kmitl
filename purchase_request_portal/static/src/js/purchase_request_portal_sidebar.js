...
publicWidget.registry.PurchaseRequestPortalSidebar = PortalSidebar.extend({
    selector: '.o_portal_purchase_request_sidebar',
    events: {
        'click .o_portal_purchase_request_print': '_onPrintPurhaseRequest',
    },
    ...
    start: function () {
        ...
        var $purchaseRequestHtml = this.$el.find('iframe#purchase_request_html');
