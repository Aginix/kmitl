This module adds the following features to asset management, aimed to follow Thai
...
Note: Users must have the permission "Enable Assets in Purchase" to view assets in the
purchase order.
