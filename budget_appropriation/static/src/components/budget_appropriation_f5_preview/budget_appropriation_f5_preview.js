...
export class BudgetAppropriationF5Preview extends Component {
    setup() {
    ...
    getMarginStyle(node) {
        if (node.type === 'fund') {
            ...
            // So account level = node.level - 2 (subtract activity and fund levels)
...
registry.category("actions").add("budget_appropriation_f5_preview", BudgetAppropriationF5Preview);