...
- [Approval Request (Expense Plan)](./agx_approval/CONTEXT.md) — expense-approval form reframed as proposing an *expense plan* (what is planned to be spent + who is involved); the payee is deliberately **not** on the plan — the recipient is settled later at disbursement. Routed for approval through e-Saraban.
