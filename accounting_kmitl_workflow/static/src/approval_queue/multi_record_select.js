 ...
 * Used for the journal / partner filters and the four KMITL dimensions on the
 * approval queue (mirrors the trial-balance report's filter widget).
 *
 * Props:
...
MultiRecordSelect.template = "accounting_kmitl_workflow.MultiRecordSelect";
