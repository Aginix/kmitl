...
class BudgetAppropriationF5PExpense(models.AbstractModel):
    """
    Budget Appropriation F5-P Expense Report - Aggregate expenses by type, category, and department.
    ...
    _name = "budget.appropriation.f5p.expense"
    _description = "Budget Appropriation F5-P Expense Report"
    ...
    def _build_category_dept_totals(self, report, dept_map):
        """
        Build (type_code, cat_name, dept_id) -> balance mapping for a report.
