...
class BudgetAppropriationF10WExpense(models.AbstractModel):
    """
    Budget Appropriation F10-W Expense Report - Hierarchical by activity plans and expense types.
    ...
    _name = "budget.appropriation.f10w.expense"
    _description = "Budget Appropriation F10-W Expense Report (Activity x Expense Type)"
    ...
    def get_data(self, report_id):
        ...
        activity_totals = self._build_activity_expense_totals(report, expense_type_map)
    ...
    def _build_activity_expense_totals(self, report, expense_type_map):
        """
