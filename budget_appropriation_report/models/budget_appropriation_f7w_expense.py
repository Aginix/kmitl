...
class BudgetAppropriationF7WExpense(models.AbstractModel):
    """
    Budget Appropriation F7-W Expense Report - Aggregate expenses by type and category.
    ...
    _name = "budget.appropriation.f7w.expense"
    _description = "Budget Appropriation F7-W Expense Report"
    ...
    def _build_category_totals(self, report):
        """
        Build (type_code, cat_name) -> balance mapping for a report.
