...
class BankPaymentExport(models.Model):
    ...
    scb_pickup_location = fields.Selection(
        selection=[
            ("C001", "C001 - Ratchayothin"),
            ("C002", "C002 - Chidlom"),
            ("C003", "C003 - Map Ta Phut"),
            ("C004", "C004 - Lat Krabang"),
            ("C005", "C005 - Tha Phae"),
            ("C006", "C006 - Asoke"),
            ("C007", "C007 - Pattaya Sai 2"),
            ("C008", "C008 - Rama 4"),
            ("C009", "C009 - Thanon Cherd Wutthakat"),
            ("C010", "C010 - Laem Chabang"),
            ("C011", "C011 - IT Square (Lak Si)"),
            ("C012", "C012 - Suvarnabhumi"),
        ],
        tracking=True,
        readonly=True,
        states={"draft": [("readonly", False)]},
