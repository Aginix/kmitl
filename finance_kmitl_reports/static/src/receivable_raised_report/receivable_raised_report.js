...
const REPORT_MODEL = "finance_kmitl_reports.receivable.raised.report";
...
/**
 * รายงานการตั้งลูกหนี้ — a register of debt raised against a customer,
 * whether or not it has since been collected.
 */
export class ReceivableRaisedReport extends Component {
    setup() {
        ...
        this.labels = {
            ...
            empty: _t("No invoices for the selected criteria."),
            dateFrom: _t("Invoice Date From"),
            dateTo: _t("Invoice Date To"),
            groupBy: _t("Group By"),
            groupBy2: _t("Then By"),
            none: _t("None"),
    ...
    async onWillStart() {
        ...
        // Default to the month in progress, the same default every other
        // KMITL finance report opens on.
        const now = new Date();
...
ReceivableRaisedReport.template = "finance_kmitl_reports.ReceivableRaisedReport";
ReceivableRaisedReport.components = {ControlPanel, MultiRecordSelect};
ReceivableRaisedReport.props = ["*"];

registry
    .category("actions")
    .add("finance_kmitl_receivable_raised_report", ReceivableRaisedReport);
