...
class ProcurementXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        for line in lines:
            ...
            sheet.write(row, 6, thai_months[line.purchase_request_eta] or '', content_format)
            sheet.write(row, 7, thai_months[line.procurement_announcement_eta] or '', content_format)
            sheet.write(row, 8, thai_months[line.approval_signing_eta] or '', content_format)
            sheet.write(row, 9, thai_months[line.contract_order_signing_eta] or '', content_format)
            sheet.write(row, 10, thai_months[line.acceptance_eta] or '', content_format)
            sheet.write(row, 11, thai_months[line.acceptance_eta] or '', content_format)
            ...
            for payment in line.payment_ids:
                ...
                sheet.write(row, 14, thai_months[payment.month] or '', content_format)
